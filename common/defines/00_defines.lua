...
NCountry = {
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.3,			-- The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.15,	-- Modifier for army equipment reinforcement speed
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 5.0,	-- Modifier for army manpower reinforcement delivery speed (travel time)
	...
	EQUIPMENT_UPGRADE_CHUNK_MAX_SIZE = 5,			-- Maximum chunk size of equipment upgrade distribution per update.
	...
	WEEKLY_STABILITY_GAIN = 0.0010,
	WEEKLY_WAR_SUPPORT_GAIN = 0.0010,
...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = -1,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	SLOWEST_SPEED = 4,
	REINFORCEMENT_REQUEST_MAX_WAITING_DAYS = 28,   -- Every X days the equipment will be sent, regardless if still didn't produced all that has been requested.
	REINFORCEMENT_REQUEST_DAYS_FREQUENCY = 28,	   -- How many days must pass until we may give another reinforcement request
